...
scene.onOverlapTile(SpriteKind.Player, sprites.builtin.forestTiles10, function on_overlap_tile2(sprite3: Sprite, location3: tiles.Location) {
    niveles()
})
//  Texto Murcielago
scene.onOverlapTile(SpriteKind.Player, assets.tile`
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        calavera
    `, function on_overlap_tile4(sprite7: Sprite, location7: tiles.Location) {
...
//  Texto cofre
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.chestClosed, function on_overlap_tile6(sprite22: Sprite, location22: tiles.Location) {
    game.showLongText("Busca y encuentra todas las bolas de dragón", DialogLayout.Bottom)
    tiles.setTileAt(location22, assets.tile`
        myTile
    `)
})
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.purpleOuterNorth2, function on_overlap_tile7(sprite52: Sprite, location52: tiles.Location) {
    niveles()
})
//  Animación subir
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        cangrejo
    `, function on_overlap_tile9(sprite2: Sprite, location2: tiles.Location) {
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.hazardLava1, function on_overlap_tile10(sprite5: Sprite, location5: tiles.Location) {
    niveles()
})
