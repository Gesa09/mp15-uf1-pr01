...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.collectibleRedCrystal, function on_overlap_tile7(sprite32: Sprite, location32: tiles.Location) {
    superar_nivel()
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        cangrejo
    `, function on_overlap_tile8(sprite2: Sprite, location2: tiles.Location) {
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.hazardLava1, function on_overlap_tile9(sprite5: Sprite, location5: tiles.Location) {
    niveles()
})
function niveles() {
    if (info.score() == 0) {
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.purpleOuterNorth2, function on_overlap_tile10(sprite52: Sprite, location52: tiles.Location) {
    niveles()
})
