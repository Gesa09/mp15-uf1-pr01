...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.purpleOuterNorth2, function (sprite52, location52) {
    niveles()
})
// Animación bajar
...
function superar_nivel () {
    ...
    if (info.score() == 1) {
        ...
        tiles.setCurrentTilemap(tilemap`nivel6`)
        tiles.placeOnTile(jugador, tiles.getTileLocation(26, 5))
    } else if (info.score() == 3) {
...
menu()
forever(function () {
    music.play(music.stringPlayable("B E G B A A C G ", 120), music.PlaybackMode.UntilDone)
})
